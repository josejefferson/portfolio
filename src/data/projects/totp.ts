...
export const TOTP: IProject = {
  ...
  images: ['/img/projects/totp/totp-destaque.webp'],
  technologies: [
    TECHNOLOGIES.solid,
  ...
  detailImages: [
    {
      ...
      src: '/img/projects/totp/totp-create-database.webp'
    },
    {
      title: 'Tela inicial',
      description:
      ...
      src: '/img/projects/totp/totp-home.webp'
    },
    {
    ...
    },
    {
      ...
      src: '/img/projects/totp/totp-recovery-words.webp'
    }
  ]
}
